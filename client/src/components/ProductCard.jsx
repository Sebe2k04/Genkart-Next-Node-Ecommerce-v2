...
const ProductCard = ({ product }) => {
  return (
    <div className="bg-white rounded-xl shadow-sm border p-5 relative group w-fit max-w-[250px] z-[10]">
      ...
      <div className="flex cursor-pointer justify-center items-center gap-1 px-3 py-1 rounded-md border hover:bg-black hover:text-white duration-200 text-sm mt-2">
